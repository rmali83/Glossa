...
const ProductivityMetrics = ({ projects = [], annotations = [] }) => {
    try {
        // Calculate productivity metrics per translator with error handling
            ...
            <div className="dashboard-card">
                <div className="card-header">
                    ...
                    <p style={{ fontSize: '0.85rem', color: '#666', marginTop: '0.5rem' }}>
                        Words per project and completion rates by translator ({projects.length} projects, {annotations.length} annotations)
                    </p>
                </div>
        ...
        console.error('Error rendering ProductivityMetrics:', error);
        return (
            <div className="dashboard-card">
                <div className="card-header">
