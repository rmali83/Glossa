...
const QualityTrendsChart = ({ data = [] }) => {
    try {
            ...
            <div className="dashboard-card">
                <div className="card-header">
                    ...
                    <p style={{ fontSize: '0.85rem', color: '#666', marginTop: '0.5rem' }}>
                        Average quality ratings and MQM scores over time ({data.length} annotations)
                    </p>
                </div>
                    ...
                    {trendData.length > 0 ? (
                        ...
                        <div style={{ 
                            ...
                            <p style={{ fontSize: '0.8rem', marginTop: '0.5rem' }}>
                                Quality trends will appear as annotations are created over time
                            </p>
                        </div>
                    )}
                </div>
        ...
        console.error('Error rendering QualityTrendsChart:', error);
        return (
            <div className="dashboard-card">
                <div className="card-header">
